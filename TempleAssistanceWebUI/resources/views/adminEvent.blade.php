                ...
                <div class="card">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Budda Pooja</td>
                            <td>Temple</td>
                            <td>On Vesak Day, Buddhists all over the world events.</td>
                            <td>2021/05/06</td>
                            <td>2021/05/18</td>
                            <td>
                                <div class="col-md-7">
                        ...
                        <tr>
                            ...
                            <td>Buddhists all over the world events.</td>
                            <td>2021/05/05</td>
                            <td>2021/05/10</td>
                            <td>
                                <div class="col-md-7">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="daneModelLabel" align="center">Update Event</h4>
                </div>
    ...
    <div class="modal fade" id="viewModel" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="daneModelLabel" align="center">Event</h4>
                </div>
                <form method="POST" action=" ">
                    @csrf
                    <div class="model-body">
                        <div class="row" >
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Event Category</label>
                                    <div class="col-md-8">
