    ...
    <aside class="main-sidebar hidden-print">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="/templeDashboard"><i class="fa fa-dashboard"></i><span>Dashboard</span></a>
                </li>
                ...
                <li class="treeview"><a href="#"><i class="fa fa-users"></i><span>Welfare Society</span><i
                            class="fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="/templeWelfareSociety"><i class="fa fa-wrench"></i>Management</a>
                        <li><a href=" /templeWelfareEvent"><i class="fa fa-globe"></i>Events</a></li>
                    </ul>
                </li>
