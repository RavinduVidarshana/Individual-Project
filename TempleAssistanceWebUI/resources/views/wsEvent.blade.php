...
@section('title','Welfare Society Event')
                ...
                <div class="card">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Anual Meeting</td>
                            <td>2</td>
                            <td>Member board anual meeting.</td>
                            <td>2021/05/06</td>
                            <td>2021/05/18</td>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td>Meeting grade Community members.</td>
                            <td>2021/05/05</td>
                            <td>2021/05/10</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="daneModelLabel" align="center">Create Welfare Society Event</h4>
                </div>
    ...
    <div class="modal fade" id="updateModel" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="daneModelLabel" align="center">Update Welfare Society Event</h4>
                </div>
                <form method="POST" action=" ">
                    @csrf
                    <div class="model-body">
    ...
    <div class="modal fade" id="viewModel" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="daneModelLabel" align="center">Welfare Society Event</h4>
                </div>
                <form method="POST" action=" ">
                    @csrf
                    <div class="model-body">
